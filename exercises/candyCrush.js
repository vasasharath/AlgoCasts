...
var candyCrush = function(board) { 
    ...
    function process(board, i, j){
        ...
        //horizontal
        while(currJ < board[0].length - 1 && Math.abs(board[i][currJ]) === Math.abs(board[i][currJ + 1])){
            currJ++;
        }        
        ...
        //vertical
        while(currI < board.length - 1 && Math.abs(board[currI][j]) === Math.abs(board[currI + 1][j])){
            currI++;
        }
